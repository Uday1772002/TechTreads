...
-- Create posts table (matching Drizzle schema)
CREATE TABLE IF NOT EXISTS "posts" (
  ...
  CONSTRAINT "posts_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE
);

-- Create comments table (matching Drizzle schema)
CREATE TABLE IF NOT EXISTS "comments" (
  ...
  CONSTRAINT "comments_parent_comment_id_comments_id_fk" FOREIGN KEY ("parent_comment_id") REFERENCES "comments"("id") ON DELETE CASCADE,
  CONSTRAINT "comments_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE
);

-- Create post upvotes table (matching Drizzle schema)
...
-- Create comment upvotes table (matching Drizzle schema)
